...
def save_examples(### PATH need to be fixed
    ...
    with open(save_name, 'wb') as pickle_file:
        pkl.dump([inputs, targets, inputs_cap], pickle_file, protocol=2)  # use 2 for compatibility with python 2

if __name__ == '__main__':
    #resize_mscoco()
    #show_examples(11, 3)
    save_examples()
    #save_examples(split="val2014", save_name="C:/Users/Wes/PycharmProjects/IFT6266Project/Data/val2014_2.pkl")